...
def search():
    ...
    max_mileage = int(request.form.get("max_mileage", 999999))
    min_year = int(request.form.get("min_year", 0))
    current_mileage = int(request.form.get("current_mileage", 0))
    current_year = int(request.form.get("current_year", 0))
    min_margin = 25000
